...
from import_historical_1m import normalize_row, apply_column_map  # noqa: E402


BASE = {
    "ticker": "PETR4", "time": "2025-01-02 10:00:00",
    "open": 30.0, "high": 30.5, "low": 29.8, "close": 30.2,
    "volume": 1000, "trades": 45,
}
...
def test_column_map_renames():
    raw = {"symbol": "VALE3", "dt": "2025-01-02 10:00", "o": 70.0,
           "h": 70.5, "l": 69.9, "c": 70.3, "vol": 500}
    mapped = apply_column_map(raw, {
        "symbol": "ticker", "dt": "time",
