...
def test_investir_color():
    assert _make(80, "INVESTIR").recommendation_color == "#00c48c"


def test_nao_investir_color():
    assert _make(30, "NÃO INVESTIR").recommendation_color == "#ff4757"


def test_aguardar_color():
    assert _make(55, "AGUARDAR").recommendation_color == "#ffb300"


def test_score_excelente():
    assert _make(80, "INVESTIR").score_label == "Excelente"


def test_score_bom():
    assert _make(65, "INVESTIR").score_label == "Bom"


def test_score_regular():
    assert _make(50, "AGUARDAR").score_label == "Regular"


def test_score_ruim():
    assert _make(30, "NÃO INVESTIR").score_label == "Ruim"
