...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "situacao", sa.String(20), nullable=True
        ),  # EM FUNCIONAMENTO NORMAL, CANCELADO...
        ...
        sa.Column(
            "publico_alvo", sa.String(100), nullable=True
    ...
    op.create_index("ix_fid_cnpj_data", "fundos_informe_diario", ["cnpj", "data_ref"], unique=True)
    ...
    op.create_index("ix_fr_cnpj_data", "fundos_rentabilidade", ["cnpj", "data_ref"], unique=True)
