...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["investment_account_id"], ["investment_accounts.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        ),  # imovel|previdencia|coe|debenture|outro
    ...
    op.add_column("portfolios", sa.Column("investment_account_id", sa.String(36), nullable=True))
    ...
    op.add_column("positions", sa.Column("investment_account_id", sa.String(36), nullable=True))
    op.create_foreign_key(
    ...
    op.add_column("rf_holdings", sa.Column("investment_account_id", sa.String(36), nullable=True))
    op.create_foreign_key(
