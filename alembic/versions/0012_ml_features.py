...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("ticker", "forecast_date", "horizon_days", name="uq_ml_forecasts"),
    )
    op.create_index("ix_ml_forecasts_ticker_date", "ml_forecasts", ["ticker", "forecast_date"])
