...
from ctypes import (
    POINTER, WinDLL,
    c_double, c_int, c_int32, c_int64, c_long,
    c_longlong, c_size_t, c_ubyte, c_uint, c_void_p, c_wchar_p
)
from profitTypes import (
    TConnectorSendOrder, TConnectorChangeOrder,
    TConnectorCancelOrder, TConnectorCancelOrders,
    TConnectorCancelAllOrders, TConnectorZeroPosition,
    TConnectorAccountIdentifier, TConnectorAccountIdentifierOut,
    TConnectorTradingAccountOut, TConnectorTradingAccountPosition,
    TConnectorOrderOut, TConnectorTrade, TConnectorOrderIdentifier,
    TConnectorAssetIdentifier, TConnectorPriceGroup,
    TConnectorTradingMessageResult, SystemTime,
    TConnectorEnumerateOrdersProc, TConnectorEnumerateAssetProc,
...
def initializeDll(path: str) -> WinDLL:
    ...
    dll.HasOrdersInInterval.argtypes = [
        POINTER(TConnectorAccountIdentifier), SystemTime, SystemTime,
    ]
    dll.HasOrdersInInterval.restype = c_int

    dll.EnumerateOrdersByInterval.argtypes = [
        POINTER(TConnectorAccountIdentifier), c_ubyte,
        SystemTime, SystemTime, c_long, TConnectorEnumerateOrdersProc,
    ]
    dll.EnumerateOrdersByInterval.restype = c_int

    dll.EnumerateAllOrders.argtypes = [
        POINTER(TConnectorAccountIdentifier), c_ubyte,
        c_long, TConnectorEnumerateOrdersProc,
    ]
    ...
    dll.EnumerateAllPositionAssets.argtypes = [
        POINTER(TConnectorAccountIdentifier), c_ubyte,
        c_long, TConnectorEnumerateAssetProc,
    ]
