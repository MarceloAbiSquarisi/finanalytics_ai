...
async def buy_asset(
    ...
    return PortfolioResponse(
        portfolio_id=p.portfolio_id, name=p.name, user_id=p.user_id, message="Compra registrada"
    )
...
async def sell_asset(
    ...
    return PortfolioResponse(
        portfolio_id=p.portfolio_id, name=p.name, user_id=p.user_id, message="Venda registrada"
    )
