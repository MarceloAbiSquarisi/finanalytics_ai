...
def _svc(request: Request):
    from finanalytics_ai.application.services.portfolio_optimizer_service import PortfolioOptimizerService
...
class OptimizeRequest(BaseModel):
    ...
    views:            list[BLView]     = Field(default_factory=list,
                                               description="Visões Black-Litterman")
    rf_tickers:       list[str]        = Field(default_factory=list,
                                               description="Tickers tratados como Renda Fixa")
