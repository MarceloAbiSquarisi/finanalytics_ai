...
async def list_strategies() -> dict[str, Any]:
    ...
    return {
        "strategies": [
            ...
            {
                "id": "setup_91",
                "name": "Setup 9.1 (Stormer)",
                "category": "Classico BR",
            ...
            },
            {
                ...
                "params": {
                    "trend_fast": {"default": 9},
                    "trend_slow": {"default": 21},
                    "lookback": {"default": 1},
                },
            },
            {
            ...
            },
            {
                ...
                "params": {
                    "trend_fast": {"default": 9},
                    "trend_slow": {"default": 21},
                    "pullback_low": {"default": 40.0},
                    "pullback_high": {"default": 60.0},
                },
            },
            {
                "id": "first_pullback",
            ...
            },
            {
                ...
                "params": {
                    "squeeze_threshold": {"default": 0.05},
...
@router.post("/run")
async def run_backtest_post(body: BacktestRequest, request: Request) -> dict[str, Any]:
