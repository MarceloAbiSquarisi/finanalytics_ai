...
@router.get("/{series}")
async def get_series(series: str, request: Request, limit: int = 500) -> dict[str, Any]:
    """
...
async def focus_expectations(indicador: str | None = None, semanas: int = 8) -> dict[str, Any]:
    """
