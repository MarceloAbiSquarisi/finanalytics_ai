...
# SQLAlchemy Models movidos pra wallet_models.py em 01/mai/2026.
# Re-export preserva imports legados (wallet_repo.InvestmentAccountModel etc.).
from finanalytics_ai.infrastructure.database.repositories.wallet_models import (  # noqa: E402, F401
    _SENSITIVE_FIELDS,
