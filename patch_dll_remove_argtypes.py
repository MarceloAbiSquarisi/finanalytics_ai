...
ANCHOR = '        # Seta argtypes=c_void_p para aceitar callback com struct como parametro.\n        from ctypes import c_void_p as _cvoid\n        self._dll.SetTradeCallbackV2.argtypes = [_cvoid]\n        self._dll.SetTradeCallbackV2(_trade_cb)\n'
REPLACEMENT = '        self._dll.SetTradeCallbackV2(_trade_cb)\n'
SENTINEL = 'SetTradeCallbackV2.argtypes'

REMOVE_SENTINEL = "SetTradeCallbackV2.argtypes"
...
def apply_patch(path, dry_run=False, check=False):
    ...
    if REMOVE_SENTINEL not in text:
        print("[OK] argtypes ja removido."); return 0
